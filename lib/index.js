...
import { __ as _, tap, groupBy, nth, match, partial, partialRight, flatten, concat, values, mapObj, map, compose as $$, filter, not } from 'ramda'
  ...
  function apply(compiler) {
    compiler.plugin('emit', (c, cb) => {
      ...
      if (config.templateExtension) {
        ...
        var fileName = path.template('./default.jade')
